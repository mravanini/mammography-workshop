...
Go to the **Amazon S3 Console** and open the bucket whose name begins with **output-bucket-mammography-workshop**:
...
Let's go back to the lab by clicking [here](/../../#3---ground-truth)
