...
![Image](./images/cc_mlo_views-annotated.png)

*Please note that some words in this module **are not** medical terms. They are being used here for the purpose of elucidation.*
...
Since some of us are not real doctors, if we miss-evaluated, using this file might harm the accuracy of our model, so we will not use this manifest during our training, but we will explain how to use it later on in this lab.
